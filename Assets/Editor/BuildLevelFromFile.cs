...
public class BuildLevelFromFile : MonoBehaviour
{
    ...
    {
        var path = EditorUtility.OpenFilePanel("level1", "", "txt");
        ...
        try
        {
            ...
            while ((line = file.ReadLine()) != null)
            {
                for (int x = 0; x < line.Length; ++x)
                {
                    ...
                    if (prefab != null)
                        createObject(prefab, root, new Vector3(x, 0, -y));
                }
    ...
    static PrefabInfo[] all = new PrefabInfo[] {
		...
		new PrefabInfo('S', "Assets/Prefabs/Suelos/SueloMadera.prefab"),
		new PrefabInfo('C', "Assets/Prefabs/Suelos/SueloCeramica.prefab"),
		new PrefabInfo('L', "Assets/Prefabs/Suelos/SueloMetal.prefab"),
		new PrefabInfo('X', "Assets/Prefabs/Suelos/Landing.prefab"),
	};
